...
export declare type ThemeBase<S, C extends string = string, F extends string = string> = {
    colors: Record<C, string>;
    styles: S;
    fonts: Record<F, TextStyle>;
};
export declare type Themes<S = {}, C extends string = string, F extends string = string> = {
    [x: string]: ThemeBase<S, C, F>;
};
...
declare class ThemeProvider extends React.PureComponent<ThemeProviderProps, {}> {
    ...
    getChildContext(): {
        getTheme: (name: string) => ThemeBase<{}, string, string>;
    };
