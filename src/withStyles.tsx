...
const withStyles = function <Styles, Theme extends ThemeBase<{}>>(stylesCallback: (theme: Theme, themeName?: string)=>Styles, themeName: (props: any)=>string = ()=>'default') {
        ...
        class Wrapper extends React.PureComponent<T, {}>{
            ...
            render() {
                ...
                const styles:any = StyleSheet.create<Styles>({ 
                    ...stylesCallback(theme, name) as any,
                })
                return (
                    <WrappedComponent
                        {...this.props}
